...
from pyshop import PyShopify

my_token = "MY_APP_TOKEN"
my_shop = "MY_SHOP_NAME"

client = PyShopify(shop_domain=my_shop, token=my_token)
...
client = PyShopify(shop_domain=my_shop, api_key=my_api_key, api_password=my_api_password)
